      ...
      <div className="container mx-auto px-4 py-16 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/courses/java-fullstack" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Java Full Stack
                </Link>
              </li>
              <li>
                <Link href="/courses/mern-stack" className="text-gray-600 hover:text-blue-600 transition-colors">
                  MERN Stack
                </Link>
              </li>
              <li>
                <Link href="/courses/python-fullstack" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Python Full Stack
                </Link>
              </li>
              <li>
                <Link href="/courses/data-science" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Data Science
                </Link>
              </li>
              <li>
                <Link href="/courses/cloud-computing" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Cloud Computing
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="tel:+918862064497" className="text-gray-600 hover:text-blue-600 transition-colors">
                  +91 88620 64497
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <Mail className="w-5 h-5 text-gray-500" />
                <a href="mailto:info@itshaala.com" className="text-gray-600 hover:text-blue-600 transition-colors">
                  info@itshaala.com
                </a>
              </li>
            </ul>
