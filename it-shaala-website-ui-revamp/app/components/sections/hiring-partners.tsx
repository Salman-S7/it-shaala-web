...
const HiringPartnerCard: React.FC<HiringPartnerCardProps> = ({ logo, name }) => {
    return (
...
const HiringPartnersMarquee = ({ hiringPartners }: { hiringPartners: HiringPartner[] }) => {

    const marquee1 = useMarquee(false);
    const marquee2 = useMarquee(true);

    return (
        <section className="py-20 bg-white overflow-hidden">
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-4xl font-bold text-gray-900 mb-4">Our <span className="text-blue-600">Hiring Partners</span></h2>
