...
const timeline = [
  {
    ...
    icon: Calendar,
    title: 'The Beginning',
    description: 'Started with 5 students in a shared workspace, focusing on practical coding education.',
  },
  {
    year: '2021',
    icon: Users,
    title: 'Community Growth',
    description: 'Expanded to 100+ students and launched our first comprehensive full-stack program.',
  },
  {
    year: '2022',
    icon: Trophy,
    title: 'Industry Recognition',
    description: "Recognized as Pune's leading coding institute with 95% placement rate.",
  },
  {
    year: '2023',
    icon: Target,
    title: 'Expanding Horizons',
    description: 'Launched specialized courses in AI/ML and cloud computing. Reached 500+ graduates.',
  },
];
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-600">
            From a small initiative to Pune's leading tech learning community
          </p>
        </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 md:p-12 rounded-2xl relative overflow-hidden">
            <div className="relative z-10">
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                To empower aspiring developers with practical, job-ready skills through immersive learning 
                and real-world project experience. We bridge the gap between academic knowledge and industry demands, 
