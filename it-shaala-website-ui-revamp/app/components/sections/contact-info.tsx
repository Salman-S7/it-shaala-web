import { MapPin, Phone, Mail, Clock, ExternalLink, CalendarCheck, BookOpen } from 'lucide-react';
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 via-white to-blue-50 p-8 rounded-2xl shadow-lg border border-gray-100 backdrop-blur-sm">
      <div className="relative overflow-hidden">
        <h2 className="text-2xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 mb-6">Contact <span className="text-blue-600">Information</span></h2>
      ...
      <div className="space-y-8">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600">
              <a href="tel:+919876543211" className="hover:text-blue-600">
                +91 98765 43211
              </a>
            </p>
            <a 
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-1">
              <a href="mailto:info@itshaala.com" className="hover:text-blue-600">
                info@itshaala.com
              </a>
            </p>
            <p className="text-gray-600">
              <a href="mailto:admissions@itshaala.com" className="hover:text-blue-600">
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
          ...
          <div className="col-span-2 mb-4 text-center">
            <p className="text-gray-600 mb-4">Ready to start your coding journey?</p>
          </div>
          <a
